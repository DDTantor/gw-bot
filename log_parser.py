...
if __name__ == "__main__":
    ...
    log_data = get_log_data("https://dps.report/lLj0-20210905-165628_arkk")
    success = log_data['success'];
    for phase in log_data['phases']:
        ...
        phase_name, start, end = get_phase_insert_info(phase, not success and phase == log_data['phases'][-1])
        print(phase_name, start, end)
